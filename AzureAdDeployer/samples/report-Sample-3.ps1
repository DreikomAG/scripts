...
$ComputerName = "<h1>OS name: " + $PSVersionTable.OS + "</h1>"

$Packages = Get-Package | ConvertTo-Html -As List -Property Name, Version -Fragment -PreContent "<h2>Package Information</h2>"
...
$Report = ConvertTo-HTML -Body "$ComputerName $Packages" -Head $header -Title "Information Report" -PostContent "<p id='CreationDate'>Creation Date: $(Get-Date)</p>"
